...
public interface Edk extends Library {
	...
	public enum EE_Event_t {
		EE_UnknownEvent(0x0000), EE_EmulatorError(0x0001), EE_ReservedEvent(0x0002), EE_UserAdded(
				0x0010), EE_UserRemoved(0x0020), EE_EmoStateUpdated(0x0040), EE_ProfileEvent(0x0080), EE_CognitivEvent(
						0x0100), EE_ExpressivEvent(0x0200), EE_InternalStateChanged(0x0400), EE_AllEvent(0x07F0);
	 ...
	 */
	int EE_ExpressivSetThreshold(int userId, int algoName, int thresholdName, int value);
	 ...
	 * \sa edkErrorCode.h, int, int
	 */
	int EE_ExpressivGetThreshold(int userId, int algoName, int thresholdName, IntByReference pValueOut);
	 ...
	 * \sa EDK_ERROR_CODE, int
	 */
	int EE_ExpressivGetTrainedSignatureActions(int userId, NativeLongByReference pTrainedActionsOut);
	 ...
	 * \sa EDK_ERROR_CODE
	 */
	int EE_ExpressivGetTrainedSignatureAvailable(int userId, IntByReference pfAvailableOut);
	 ...
	 * \sa edkErrorCode.h, int, int
	 */
	int EE_CognitivSetCurrentLevel(int userId, int level, int level1Action, int level2Action, int level3Action,
			int level4Action);
	 ...
	 * \sa edkErrorCode.h, int, int
	 */
	int EE_CognitivGetCurrentLevel(int userId, IntByReference pLevelOut, IntByReference pLevel1ActionOut,
			IntByReference pLevel2ActionOut, IntByReference pLevel3ActionOut, IntByReference pLevel4ActionOut);
	 ...
	 * \sa edkErrorCode.h
	 */
	int EE_CognitivGetActionSensitivity(int userId, IntByReference pAction1SensitivityOut,
			IntByReference pAction2SensitivityOut, IntByReference pAction3SensitivityOut,
	 ...
	 */
	int EE_OptimizationGetVitalAlgorithm(Pointer hParam, int suite, IntByReference pVitalAlgorithmBitVectorOut);
	 ...
	 */
	int EE_OptimizationSetVitalAlgorithm(Pointer hParam, int suite, int vitalAlgorithmBitVector);

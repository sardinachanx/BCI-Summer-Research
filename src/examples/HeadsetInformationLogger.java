...
public class HeadsetInformationLogger{
	public static void main(String[] args){
		...
		System.out.println("Time, Wireless Strength, Battery Level, AF3, " + "T7, Pz, T8, AF4");
		...
		while(true){
			...
			if(state == EdkErrorCode.EDK_OK.ToInt()){
				...
				if(readytocollect && onStateChanged){
					...
					System.out.print(
							EmoState.INSTANCE.IS_GetContactQuality(eState, IEE_InputChannels_t.IEE_CHAN_AF3.getType())
									+ ", ");
					System.out.print(
							EmoState.INSTANCE.IS_GetContactQuality(eState, IEE_InputChannels_t.IEE_CHAN_T7.getType())
									+ ", ");
					System.out.print(
							EmoState.INSTANCE.IS_GetContactQuality(eState, IEE_InputChannels_t.IEE_CHAN_Pz.getType())
									+ ", ");
					System.out.print(
							EmoState.INSTANCE.IS_GetContactQuality(eState, IEE_InputChannels_t.IEE_CHAN_T8.getType())
									+ ", ");
					System.out.println(
							EmoState.INSTANCE.IS_GetContactQuality(eState, IEE_InputChannels_t.IEE_CHAN_AF4.getType())
									+ ", ");
				}
			}

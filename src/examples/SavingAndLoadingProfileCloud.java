...
import com.emotiv.Iedk.EmotivCloudErrorCode;
				...
				switch(option){
					case 1:{
						...
						if(profileID >= 0){
							...
							if(EmotivCloudClient.INSTANCE.EC_UpdateUserProfile(userCloudID.getValue(),
									engineUserID.getValue(), profileID) == EmotivCloudErrorCode.EC_OK.ToInt()){
						...
						else if(EmotivCloudClient.INSTANCE.EC_SaveUserProfile(userCloudID.getValue(),
								engineUserID.getValue(), profileName, 0) == EmotivCloudErrorCode.EC_OK.ToInt()) // Training
						{
					...
					case 2:{
						if(getNumberProfile > 0){
							int profileID = EmotivCloudClient.INSTANCE.EC_GetProfileId(userCloudID.getValue(),
									profileName);

							if(EmotivCloudClient.INSTANCE.EC_LoadUserProfile(userCloudID.getValue(),
									engineUserID.getValue(), profileID, version) == EmotivCloudErrorCode.EC_OK.ToInt()){
